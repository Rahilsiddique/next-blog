          ...
          <div className="flex justify-center mt-8 space-x-6">
            <a href="#" className="text-gray-400 hover:text-gray-500">
              ...
              <svg
                ...
                viewBox="0 0 24 24"
              >
                {/* Replace with Facebook SVG path */}
            ...
            <a href="#" className="text-gray-400 hover:text-gray-500">
              ...
              <svg
                ...
                viewBox="0 0 24 24"
              >
                {/* Replace with Instagram SVG path */}
            ...
            <a href="#" className="text-gray-400 hover:text-gray-500">
              ...
              {/* Replace with Dribbble SVG icon */}
              <svg
                className="w-6 h-6"
                aria-hidden="true"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
                {/* Replace with Dribbble SVG path */}
